...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: "/exams",
    name: "exams",
    component: () => import("@/features/exams/views/ExamOverviewView.vue"),
    meta: { requiresAuth: true },
  },
  {
  ...
  {
    path: "/exams/:examSlug/result",
    name: "exam-result",
    component: () => import("@/features/exams/views/ExamResultView.vue"),
    meta: { requiresAuth: true },
  },
  {
    path: "/exams/:examSlug/history",
    name: "exam-history",
    component: () => import("@/features/exams/views/ExamAttemptHistoryView.vue"),
    meta: { requiresAuth: true },
  },
  {
    path: "/projects/new",
  ...
  },
  {
    path: "/pricing",
    name: "pricing",
    component: () => import("@/features/billing/views/PricingView.vue"),
